...
from Visualization_Utils import plot_test_sequence
...
data_dir_eeg = "../data_2013/EEG_Fpz-Cz/traindata_smote"
...
# train_history_over_CV, val_history_over_CV, confusion_matrix = run_experiment_cross_validation(model, data_dir_eeg, num_folds, num_epochs,
#                                                                                                learning_rate, batch_size, device, do_balance=do_balance, sampling=1, do_print=True)
#
#
