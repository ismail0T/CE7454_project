...
class SeqDataLoader(object):
    ...
    def load_data_lite(self, seq_len=10, shuffle = False, n_files=None):
        # Remove non-mat files, and perform ascending sort
        allfiles = os.listdir(self.data_dir)
        npzfiles = []
        for idx, f in enumerate(allfiles):
        ...
        # print(len(npzfiles))
        # train_files = np.array_split(npzfiles, 20)
        # subject_files = train_files[5]

        train_files = npzfiles[0:20]
        subject_files = npzfiles[20:30]
